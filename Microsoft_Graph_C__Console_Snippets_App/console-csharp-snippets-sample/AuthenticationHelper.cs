...
namespace console_csharp_snippets_sample
{
    class AuthenticationHelper
    {
        ...
        public static ConfidentialClientApplicationBuilder IdentityAppOnlyApp = new ConfidentialClientApplicationBuilder(clientIdForApp, Constants.AuthorityUri, Constants.RedirectUriForAppAuthn, new ClientCredential(Constants.ClientSecret), new TokenCache(), new TokenCache());
